...
const Card: React.FC<Props> = ({ }) => {
    ...
    const error = [date, period, unchecked, checked, dunchecked, dchecked].filter((v) => v).length !== 2;
                ...
                <Box sx={{ display: 'flex' }}>
                    <FormControl sx={{ m: 3 }} component="fieldset" variant="standard">
                        <FormGroup row className={classes.checkGroup}>
                            ...
                            <FormControlLabel
                                control={
                                    <Checkbox checked={period} onChange={handleChange} name="period" />
                                }
                                label="Period"
                            />
                            <FormControlLabel
                                control={
                                    <Checkbox checked={unchecked} onChange={handleChange} name="unchecked" />
                                }
                                label="Unchecked"
                            />
                            <FormControlLabel
                            ...
                            <FormControlLabel
                                control={
                                    <Checkbox checked={dunchecked} onChange={handleChange} name="dunchecked" />
                                }
                                label="Disabled Unchecked"
                            />
                            <FormControlLabel
                                control={
                                    <Checkbox checked={dchecked} onChange={handleChange} name="dchecked" />
                                }
